...
export default function RoomsShowcase(){
    ...
    return(<div className="w-full flex flex-row bg-white px-5 py-10">
            <div className='room-showcase basis-1/3 mx-5 text-center'>
                ...
                <p className='py-5 text-black font-semibold'>INR 1299/DAY</p>
            ...
            <div className='room-showcase basis-1/3 mx-5 text-center'>
                ...
                <p className='py-5 text-black font-semibold '>INR 499/DAY</p>
            ...
            <div className='room-showcase basis-1/3 mx-5 text-center'>
                ...
                <p className='py-5 text-black font-semibold '>INR 999/DAY</p>
